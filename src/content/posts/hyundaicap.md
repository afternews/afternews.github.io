---
title: "현대차 시총 반토막의 기준일은 사상 최고가를 찍은 6월 1일입니다"
description: 현대차 시가총액이 153조 5683억원에서 74조 7366억원으로 51.33% 줄었다는 계산은 정확합니다. 다만 기준일인 6월 1일은 주가가 사상 최고였던 날이고, 같은 기간 코스피도 21.55% 내렸습니다. 연초와 비교하면 현대차 주가는 아직 22% 높습니다.
pubDate: 2026-09-21
tags: ['자료 해부', '판단하는 법']
...
「석 달 만에 시가총액 반토막」이라는 문장은 강합니다. 그런데 이런 문장을 읽을 때는 반드시 확인해야 하는 것이 하나 있습니다. 무엇과 비교한 값인가입니다.

먼저 용어를 맞춰 두겠습니다. 시가총액은 주가에 상장된 주식 수를 곱한 값입니다. 회사 전체에 시장이 붙인 값이라고 보면 됩니다. 주식 수가 변하지 않는 동안에는 주가가 절반이 되면 시가총액도 절반이 됩니다.
...
**Q. 장중 최고가와 종가는 왜 구별해야 하나요?**

장중 최고가는 그날 하루 중 가장 비싸게 거래된 한순간의 값입니다. 그 값으로 실제 거래된 주식은 전체의 일부일 수 있습니다. 반면 종가는 그날 거래가 끝나는 시점에 시장이 합의한 값이고, 시가총액과 주가지수는 모두 종가로 계산합니다. 두 값을 섞어 쓰면 비교가 어긋납니다.
